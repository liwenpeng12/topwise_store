 ...
 */
package com.topwise.topos.appstore.conn.http;
...
public class FinalHttp {
	...
	private final HashMap<String, String> clientHeaderMap;
	...
	private static final FinalHttp mInstance = new FinalHttp();
	...
	// ------------------get 请求-----------------------
	public Object get(String url, AjaxCallBack<? extends Object> callBack) {
		return get(url, null, callBack);
	}

	public Object get(String url, AjaxParams params, AjaxCallBack<? extends Object> callBack) {
	...
	public HttpHandler<File> download(String url, AjaxParams params, String target, boolean isResume,
		...
		get.setHeader(HEADER_ACCEPT_ENCODING, "identity");
	...
	protected <T> Object sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest,
			String contentType, AjaxCallBack<T> ajaxCallBack) {
		if (contentType != null) {
			uriRequest.addHeader("Content-Type", contentType);
		}

		return new HttpHandler<T>(client, httpContext, ajaxCallBack, charset).executeOnExecutor(executor, uriRequest);
