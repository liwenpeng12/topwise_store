...
public class ProgressDialog extends AlertDialog {
        ...
        if (mProgressStyle == STYLE_HORIZONTAL) {
            ...
            mViewUpdateHandler = new Handler(Looper.getMainLooper()) {
                ...
                public void handleMessage(Message msg) {
                    ...
                    Log.d("chenwm", "getProgress=" + progress);
            ...
            View view = inflater.inflate(R.layout.as_alert_dialog_progress, null);
            mProgress = (ProgressBar) view.findViewById(R.id.progress);
            mProgressNumber = (TextView) view.findViewById(R.id.progress_number);
            mProgressPercent = (TextView) view.findViewById(R.id.progress_percent);
            setView(view);
        } else {
            View view = inflater.inflate(R.layout.as_progress_dialog, null);
            mProgress = (ProgressBar) view.findViewById(R.id.progress);
    ...
    public void setProgress(int value) {
        Log.d("chenwm", "setProgress=" + value + "; mHasStarted=" + mHasStarted);
        if (mHasStarted) {
