...
public class AlertController {
    ...
    private final WindowProxy mWindowProxy;
    ...
    public  boolean mDisplayCheckbox = false;
    
    public OnCheckedChangeListener mlistenter;
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(AlertDialogHelper.getInternalResource("attr","alertDialogCenterButtons"),
                outValue, true);
    ...
    public AlertController(Context context, DialogInterface di, Window window) {
        ...
        mDialogInterface = di;
        mWindow = window;
        mWindowProxy = new WindowProxy(window);
        mHandler = new ButtonHandler(di);

        mAlertDialogLayout = R.layout.as_alert_dialog;
        mListLayout = R.layout.as_select_dialog;
        mMultiChoiceItemLayout = R.layout.as_select_dialog_multichoice;
        mSingleChoiceItemLayout = R.layout.as_select_dialog_singlechoice;
        mListItemLayout = R.layout.as_select_dialog_item;
    }
    ...
    private void setupView() {
        ...
        if (!hasButtons) {
            ...
            mWindowProxy.setCloseOnTouchOutsideIfNotSet(true);
        }
        ...
        if (hasTitle) {
            ...
            // modified by chenweiming 2014-06-19
            // ����ʽ����Ҫ��ʾ�ָ���
//            if (divider != null) {
...
//            }
    ...
    private void setupContent(LinearLayout contentPanel) {
        ...
        mCheckBoxContainer = (View) mWindow.findViewById(R.id.checkbox_layout);
        mCheckBox = (CheckBox) mWindow.findViewById(R.id.checkbox_btn);
        if(mlistenter!=null) {
            mCheckBox.setOnCheckedChangeListener(mlistenter);
        }
        if (mMessage != null) {
...
//        int fullDark = R.drawable.alert_dialog_full;
//        int topDark = R.drawable.alert_dialog_top;
//        int centerDark = R.drawable.alert_dialog_middle;
//        int bottomDark = R.drawable.alert_dialog_bottom_bright;
//        int fullBright = R.drawable.alert_dialog_full;
//        int topBright = R.drawable.alert_dialog_top;
//        int centerBright = R.drawable.alert_dialog_middle;
//        int bottomBright = R.drawable.alert_dialog_bottom_bright;
//        int bottomMedium = R.drawable.alert_dialog_bottom;
    	
        int fullDark = R.drawable.as_alert_dialog_full;
        int topDark = R.drawable.as_alert_dialog_top;
        int centerDark = R.drawable.as_alert_dialog_middle;
        int bottomDark = R.drawable.as_alert_dialog_bottom_bright;
        int fullBright = R.drawable.as_alert_dialog_full;
        int topBright = R.drawable.as_alert_dialog_top;
        int centerBright = R.drawable.as_alert_dialog_middle;
        int bottomBright = R.drawable.as_alert_dialog_bottom_bright;
        int bottomMedium = R.drawable.as_alert_dialog_bottom;
